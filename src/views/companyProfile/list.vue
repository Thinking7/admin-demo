<template>
  <div class="app-container">
    <el-breadcrumb separator-class="el-icon-arrow-right">
        <router-link :to="'/companyProfile/edit'">

        <el-button type="primary" icon="el-icon-edit" style="margin-bottom:20px;float: right;">
          添加
        </el-button>
      </router-link>
    ...
    <el-table
      ...
      <el-table-column prop="sub_title" label="短标题" ></el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <router-link :to="'/companyProfile/edit?id='+scope.row.id">
            <el-button
              size="mini">编辑
            </el-button>
          </router-link>
...
<script>
  import {fetchList, edit, del} from '@/api/companyProfile'
